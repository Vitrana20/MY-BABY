...
document.getElementById("siBtn").addEventListener("click", function () {
  ...
  document.getElementById("messageContainer").innerHTML = "Oh Yes,Jajaja ";
  ...
  switch (noButtonState) {
    case 0:
      ...
      document.getElementById("noBtn").innerHTML =
        "Anh phải bấm bên trái chứ :( Đồ tòyyy ";
    ...
    case 1:
      ...
      document.getElementById("noBtn").innerHTML = "Anh chắc chưa????";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
      document.getElementById("sadGifContainer").style.display = "none";
    ...
    case 2:
      document.getElementById("noBtn").innerHTML =
        "Anh không kiếm được ai như em đâu";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
      document.getElementById("sadGifContainer").style.display = "none";
      document.getElementById("sadGifContainer2").style.display = "none";
    ...
    case 3:
      document.getElementById("noBtn").innerHTML = " Đừng mà cục cưngg  ";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 4:
      document.getElementById("noBtn").innerHTML =
        "Anh đang làm trái tim em tan nát đó huhu ";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 5:
      document.getElementById("noBtn").innerHTML =
        "Công chúa dễ thương như em anh tìm không ra nữa đâu!!!";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 6:
      document.getElementById("noBtn").innerHTML =
        "Em nguyện dâng hiến trái tim này cho anh ";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 7:
      document.getElementById("noBtn").innerHTML =
        "Anh hãy làm người iuuuu của em nhé <3 ";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 8:
      document.getElementById("noBtn").innerHTML =
        "Anh không có quyền lựa chọn nào khác đâu!!!";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 9:
      document.getElementById("noBtn").innerHTML =
        "Anh chỉ có thể là người đàn ông của em thoyyy";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 10:
      document.getElementById("noBtn").innerHTML =
        "Bỏ qua em anh sẽ hối hận đấyyy";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
      ...
      break;
    case 11:
      document.getElementById("noBtn").innerHTML = "Anh đồng ý đi màaaaa";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 12:
      document.getElementById("noBtn").innerHTML =
        "Công chúa này anh mà không giữ người khác sẽ giữ thay anh đó";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 13:
      document.getElementById("noBtn").innerHTML =
        "Cục cưng ơi, anh nỡ lòng nào làm thế :(";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 14:
      document.getElementById("noBtn").innerHTML =
        "Nâu naauuuu....anh lại bấm nhầm rồi, phải bấm  bên trái chứ";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 15:
      document.getElementById("noBtn").innerHTML =
        "Anh đồng ý đi mà , làm người iu em nhaaaa, được honggg anh :(";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
